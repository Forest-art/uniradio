...
#SBATCH --output=/project/peilab/luxiaocheng/projects/DSGA/slurm/logs/rae_rmse_rfid-%j.out
#SBATCH --error=/project/peilab/luxiaocheng/projects/DSGA/slurm/logs/rae_rmse_rfid-%j.err
...
python -m unirae.eval_rae_table1_baselines \
  ...
  --stage1_config /project/peilab/luxiaocheng/projects/RAE/configs/stage1/pretrained/DINOv2-B.yaml \
